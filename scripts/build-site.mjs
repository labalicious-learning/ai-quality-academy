...
const nav=(prefix='')=>'<header class="top"><a class="wordmark" href="'+prefix+'index.html"><span class="mark">la</span>Labalicious Academy</a><nav><a href="'+prefix+'labs/00-course-setup.html">Start here</a><a href="'+prefix+'index.html#sessions">Sessions</a>'+(repoUrl?'<a href="'+repoUrl+'">Course repository ↗</a>':'')+'</nav></header>';
...
function document(title,body,prefix=''){return '<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'+escape(title)+' · Labalicious Academy</title><link rel="stylesheet" href="'+prefix+'assets/style.css">'+nav(prefix)+'<main class="document"><a class="breadcrumb" href="'+prefix+'index.html">← All sessions</a>'+body+'</main>'+footer(prefix)+'</html>';}
...
await writeFile(path.join(out,'index.html'),html.replace('>Sessions</a>','>Sessions</a><a href="reader.html">Markdown reader</a>'));
