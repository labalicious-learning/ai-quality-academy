...
const nav=(prefix='')=>'<header class="top"><a class="wordmark" href="'+prefix+'index.html"><img class="brand-logo" src="'+prefix+'assets/labalicious-logo.png" alt="" width="52" height="52"><span>Labalicious<small>AI & QA ACADEMY</small></span></a><nav aria-label="Main navigation"><a href="'+prefix+'labs/00-course-setup.html">Start here</a><a href="'+prefix+'index.html#sessions">Sessions</a><a href="'+prefix+'COURSE_PROJECT.html">Your project</a><a href="'+prefix+'SUBMISSIONS.html">Submit work</a><a href="'+prefix+'reader.html">Markdown reader</a>'+(repoUrl?'<a href="'+repoUrl+'">Course repository ↗</a>':'')+'</nav></header>';
const footer=(prefix='')=>'<footer><span>© 2026 Jared Cluff. All rights reserved.<br>Learn by doing. Every example is fictional.</span><nav><a href="'+prefix+'COPYRIGHT.html">Copyright</a><a href="'+prefix+'INSTRUCTOR_GUIDE.html">Instructor guide</a><a href="'+prefix+'PUBLICATION.html">About this course</a></nav></footer>';
...
'Present your own polished software, GitHub history and quality evidence to Jared.'
];
const cards=[];
