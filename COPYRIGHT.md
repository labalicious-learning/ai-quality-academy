...
This notice covers the original Labalicious course materials, lesson plans, labs, slides, documentation, source code, templates, fictional fixtures, website design and brand assets in this repository, and their generated HTML, PDF and PowerPoint versions, to the extent those materials are protected by copyright and the rights are held by Jared Cluff.

Public availability is not an open-source or Creative Commons license. Except as authorized by Jared Cluff, applicable law or the hosting platform's terms, no permission to reproduce, redistribute, modify or commercially reuse these materials is granted by this notice. Course participation follows the permissions supplied by the instructor; contact Jared Cluff through the course repository for other permissions.
